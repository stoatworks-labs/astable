/*
 * Stoatworks Labs - About window data for Astable.
 *
 * PROVISIONAL, hand-written in the shape stoatworks-backend/scripts/sync-about.py
 * generates. Astable is not yet registered in the website's projects.json, so
 * the sync cannot produce this file; once it is, `sync-about.py --only astable
 * --apply` overwrites this with the generated copy. The facts below are the
 * ones that registration will carry, so the parameter count -- which depends
 * on how many links are present -- does not change when it does.
 *
...
{
    inline constexpr auto name = "Astable";
    inline constexpr auto slug = "astable";
    inline constexpr auto hook = "Six 555 timers into a TV yoke, for Resolume";
    inline constexpr auto licence = "MIT";
    inline constexpr auto guide = "";
    inline constexpr auto page = "https://stoatworks-labs.com/software/astable/";
    inline constexpr auto repo = "https://github.com/stoatworks-labs/astable";
