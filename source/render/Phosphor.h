...
/**
    ...
    nice. astable adds P4 (the monochrome TV white, its default) and a P22
    white at the front of vectrix's six; see the table for what a "P22" means
    for a single-beam model. Two consequences follow, and both of them will read as bugs to somebody
...
/// Clamped: an out-of-range index returns entry 0 (P4) rather than reading off the end.
